...
/// Tether is PRESENCE-ONLY: it carries no commands. Device commands flow on
/// the mobile bus (regi.mobile.requests) and are pulled by the Phone panel over
/// HTTP; presence exists only so the web can gate whether a capture may be
/// requested at all.
